...
|---|---|---|---|---|
| `REQ-PAIR` route-local complete pair/precedence | [Master §6](../../master-design.md#6-핵심-불변조건과-atomic-mutation), `Q-REQ-01~02` | Structure gate, delivery-only logical pickup, real pair order | `RouteStructureValidatorTest.*` | `E-P03-PROPAGATION` |
