...
`stage-04-initial-solution-heuristics.md`가 초기해 기법 22개를,
...
| 4-초기해 | [stage-04-initial-solution-heuristics.md](stage-04-initial-solution-heuristics.md) | 초기해 construction 22개 포트폴리오 (기본 8 + 확장 14, 결정적·rule 기반) — **먼저** | 작성됨 |
| 4-초기해 | [stage-04-initial-solution-heuristics-survey.md](stage-04-initial-solution-heuristics-survey.md) | ↑의 **근거 문서** — 문헌·솔버 조사, 확장 14개의 출처·기각 사유·22 → 4 비교 프로토콜 (계약 아님) | 작성됨 |
