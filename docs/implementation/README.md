...
`stage-04-initial-solution-heuristics.md`가 초기해 기법 24개를,
...
| 4-초기해 | [stage-04-initial-solution-heuristics.md](stage-04-initial-solution-heuristics.md) | 초기해 construction 24개 포트폴리오 (기본 8 + 확장 14 + 실물 맞춤 2, 결정적·rule 기반) — **먼저** | 작성됨 |
...
| 4-초기해 | [stage-04-zone-quota-frontier-budget.md](stage-04-zone-quota-frontier-budget.md) | 존 배정 DP 프론티어의 잎 예산·절단 규칙 재설계 — R별 memo·선착순 배분을 존당 1회 공유 열거로(실물 ZONE_29 2,348,844 → 1,933잎, 답 동일), 후보 상한. 31종 실측 | 구현 완료 (2026-09-06) |
