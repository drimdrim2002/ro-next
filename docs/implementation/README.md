...
`stage-04-initial-solution-heuristics.md`가 초기해 기법 8개를,
...
| 4-초기해 | [stage-04-initial-solution-heuristics.md](stage-04-initial-solution-heuristics.md) | 초기해 construction 8개 포트폴리오 (결정적·rule 기반) — **먼저** | 작성됨 |
