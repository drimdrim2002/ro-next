...
질문 상태는 [Canonical Master](../../2026-07-31-phase-b-master-design.md)와 [질문 등록부](../../master-design-open-questions.md)의 최신 값인 `RESOLVED 26`, `OPEN — EXPERIMENT_REQUIRED 1`, `DEFERRED 1`을 적용한다. Final Domain/Architecture에 남은 과거 `25/1/2`, `Q-INFRA-01 DEFERRED` 표기는 이 Phase의 결정을 되돌리지 않는다. `Q-BENCH-02`, `C-17`, `Q-VAR-01`과 public API/schema 미확정 항목은 임의의 수치·default·완료 상태로 바꾸지 않는다.
...
| 입력 | 역할 |
|---|---|
| [Canonical Master](../../2026-07-31-phase-b-master-design.md) | 전체 requirement, 결정, 불변조건과 `RM-1` gate |
