...
|---|---|---|
| [Canonical Master](../../2026-07-31-phase-b-master-design.md) | §1~§4, §10~§17, 특히 `C-17`, §11.7~§11.10, `RM-9A~C`, §16.3 | GATED target, immutable pool, exact projection, materialize/full-evaluate/strict adoption, two-gate authority, fallback와 별도 approval |
