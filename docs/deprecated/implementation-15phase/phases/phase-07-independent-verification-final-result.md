...
|---|---|---|
| [Canonical Master](../../2026-07-31-phase-b-master-design.md) | §2.2~§2.4, §4.1~§4.6, §6, §10, §12~§14.1, §15.7, §16~§17 | 두 verifier, route/bank와 result 분리, final audit, cache 비권위, provenance, `RM-5` gate |
...
| `REQ-TRAVEL` same complete prepared authority | [Master §4.2](../../2026-07-31-phase-b-master-design.md#42-단계별-데이터-계약), [Phase 02 §13.3](phase-02-prepared-travel-immutable-problem.md#133-이후-consumer) | §4/§7.2 authority equality | `CandidateVerifierAuthorityTest.*PreparedTravel*` | `E-P07-CANDIDATE-VERIFY` |
...
| `REQ-PAIR` complete pair/same vehicle/precedence/route-bank XOR | [Master §6](../../2026-07-31-phase-b-master-design.md#6-핵심-불변조건과-atomic-mutation), `C-06` | §3.2/§9.1 partition | `CandidatePartitionCorruptionTest.*` | `E-P07-CANDIDATE-VERIFY` |
| `REQ-CACHE` cache-free recomputation | [Master §12](../../2026-07-31-phase-b-master-design.md#12-candidate-state-cache와-rollback), [Master §14.1](../../2026-07-31-phase-b-master-design.md#141-publication-gate) | Search claims non-authoritative | `CandidateVerifierIndependenceTest.*`, claim tamper tests | `E-P07-CANDIDATE-VERIFY` |
...
| `REQ-RESULT` search bank/outcome separation | `C-15`, [Master §10](../../2026-07-31-phase-b-master-design.md#10-search-solution과-final-result), `Q-RES-01` | Two-state final outcome | `FinalOutcomeTest.*` | `E-P07-AUDIT` |
| `REQ-AUDIT` static proven + required final audit | `Q-RES-02`, [Master §10.2](../../2026-07-31-phase-b-master-design.md#102-finalization과-result) | §7.5/§9.2 exhaustive contract | `FinalInsertionAuditTest.*`, completeness property | `E-P07-AUDIT` |
| `REQ-DIAGNOSTIC` evidence-bounded confidence | [Master §10.2](../../2026-07-31-phase-b-master-design.md#102-finalization과-result), [Final Domain §15](../../2026-07-26-domain-design.md#15-verification-finalization과-result) | Source/scope/confidence matrix | Audit/diagnostic confidence tests | `E-P07-AUDIT`, `E-P07-RESULT-VERIFY` |
| `REQ-VERIFY` two independent verifier gates | `C-21`, [Master §14.1](../../2026-07-31-phase-b-master-design.md#141-publication-gate) | Candidate/result PASS separation | `BothGatePublicationTest.*` | `E-P07-CANDIDATE-VERIFY`, `E-P07-RESULT-VERIFY` |
| `REQ-INCOMPLETE` gate fail와 incomplete 분리 | [Master §10.2](../../2026-07-31-phase-b-master-design.md#102-finalization과-result), [Master §14.1](../../2026-07-31-phase-b-master-design.md#141-publication-gate) | `VerificationRejected` 대 `GateIncomplete`; 둘 다 normal payload 0 | `BothGatePublicationTest.*GateIncomplete*` | `E-P07-RESULT-VERIFY` |
...
| `REQ-PROVENANCE` input→replay→both-gate lineage | [Master §10.3](../../2026-07-31-phase-b-master-design.md#103-result-provenance), [Integrated §19](../../architecture-domain-implementation-design.md#19-configuration-provenance와-observability) | §7.3/§7.6 manifest | `Phase07ReplayReproducibilityTest.*` | All P07 keys |
| `REQ-REPRO` canonical result determinism | `C-22`, [Master §13.2](../../2026-07-31-phase-b-master-design.md#132-strong-reproducibility-envelope) | Stable semantic/payload identity | `CanonicalResultEncodingTest.*` | `E-P07-RESULT-VERIFY` |
