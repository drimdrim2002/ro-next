...
|---|---|---|
| [Canonical Master](../../2026-07-31-phase-b-master-design.md) | §1.1~§1.5, §2.4, §3.2~§3.3, §4.1~§4.7, §13, §15.1~§15.3, §16~§17 | 설계/구현 상태 분리, dependency direction, lifecycle, RM-0/RM-1 gate, migration·reproducibility |
