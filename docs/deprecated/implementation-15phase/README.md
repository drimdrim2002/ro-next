> **ARCHIVED (2026-08-09)** — 이 15-phase 세트는 폐기된 2026-07-26 설계 기준으로 작성되어 아카이브되었다. 현재 구현 계획: [docs/implementation-plan.md](../../implementation-plan.md)
...
1. [문서 지도](../../README.md)
2. [Canonical Master](../2026-07-31-phase-b-master-design.md) (`APPROVED`) — 시스템 의미, 확정 결정, 완료 정의와 gate
3. [Domain Design](../2026-07-31-phase-b-domain-design.md) (`APPROVED`) — 값·수식·정규화·travel·전파·평가·결과 의미
4. [Architecture Design](../2026-07-31-phase-b-architecture-design.md) (`APPROVED`) — module/package/port/runtime 배치
...
5. [Historical Final Domain (2026-07-26, SUPERSEDED)](../2026-07-26-domain-design.md)
6. [Historical Final Architecture (2026-07-26, SUPERSEDED)](../2026-07-26-architecture-design.md)
7. [Historical integrated implementation design (SUPERSEDED)](../architecture-domain-implementation-design.md)
8. [Historical open-questions registry (SUPERSEDED)](../master-design-open-questions.md)
...
[2026-07-26 Master Design — SUPERSEDED](../2026-07-26-master-design.md)는 역사 cross-check에만 사용한다.  
